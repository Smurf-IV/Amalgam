...
STDDLLAPIPTR_( BOOL, InstallAFN)( IN LPCSTR CabPathName, IN LPCSTR ProductName, IN BOOL SupportPnP, IN DWORD ModulesToInstall, OUT LPDWORD RebootNeeded );
STDDLLAPIPTR_( BOOL, InstallWFN)( IN LPCWSTR CabPathName, IN LPCWSTR ProductName, IN BOOL SupportPnP, IN DWORD ModulesToInstall, OUT LPDWORD RebootNeeded );

STDDLLAPIPTR_( BOOL, UninstallAFN)( IN LPCSTR CabPathName, IN LPCSTR ProductName, OUT LPDWORD RebootNeeded );
STDDLLAPIPTR_( BOOL, UninstallWFN)( IN LPCWSTR CabPathName, IN LPCWSTR ProductName, OUT LPDWORD RebootNeeded );
...
public:
   ...
   BOOL Install( IN LPCTSTR CabPathName, IN LPCTSTR ProductName, IN BOOL SupportPnP, IN DWORD ModulesToInstall, OUT LPDWORD RebootNeeded );
   BOOL Uninstall( IN LPCTSTR CabPathName, IN LPCTSTR ProductName, OUT LPDWORD RebootNeeded );
